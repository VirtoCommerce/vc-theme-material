...
2. Clone repo.
    1. In Visual Studio, go to **Team Explorer** → **Clone** → Enter https://github.com/VirtoCommerce/vc-theme-material.git as URL and **C:\vc-theme-material** (for example) as path.
    2. Or execute command
        ```
        git clone https://github.com/VirtoCommerce/vc-theme-material.git "C:\vc-theme-material"
        ```
        (where **C:\vc-theme-material** is path to folder where you want to clone repo).
3. Link you theme repo to store. Execute:
    ```
    mklink /d "C:\vc-platform\VirtoCommerce.Platform.Web\App_Data\cms-content\Themes\Clothing\default" "C:\vc-theme-material"
    ```
    (where **C:\vc-platform\VirtoCommerce.Platform.Web\App_Data\cms-content** is path to CMS content storage configured at platform & storefront deployment steps, **'Clothing'** is your store name and **'C:\vc-theme-material'** is path to your theme repo).
4. Open theme folder in your IDE
    ...
    3. Select **C:\vc-theme-material** (where **C:\vc-theme-material** is path to folder where you want to clone repo) and open it.
